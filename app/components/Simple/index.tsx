    ...
    return (
        <div className="simple-bg relative">
            ...
            <div className="mx-auto max-w-5xl py-24 px-6">
                ...
                <p className="text-center text-bluish text-lg font-normal mb-8">HMIF UNSRI adalah organisasi kemahasiswaan yang bergerak di bidang teknik informatika, yang bertujuan untuk meningkatkan kualitas akademik, non-akademik, dan kekeluargaan mahasiswa Teknik Informatika FASILKOM UNSRI, serta berkontribusi untuk pengembangan ilmu pengetahuan dan teknologi di Indonesia.</p>
